  ...
  return (
    <section className="space-y-6">
      <header className="surface-card rounded-3xl p-6">
        ...
        <h1 className="mt-3 text-2xl font-black text-slate-900">見方ガイド</h1>
        <p className="mt-2 text-sm leading-7 text-slate-600">
          同じ seed の同一データで、Baseline（現在方式）と DA を比較します。
          方式だけを変えたとき、結果がどう動くかを短時間で確認できます。
        </p>
      </header>
      ...
      <section className="grid gap-4 md:grid-cols-2">
        ...
        <article className="surface-card rounded-2xl p-5">
          ...
          <p className="mt-2 text-sm text-slate-600">
            候補者・部署の双方が「今よりこの組合せがよい」と思う組合せ。少ないほど揉めにくい。
          </p>
        </article>
        <article className="surface-card rounded-2xl p-5">
          <h2 className="text-base font-bold text-slate-800">
      ...
      <section className="surface-card rounded-2xl p-5">
        ...
        <ul className="mt-3 list-disc space-y-2 pl-5 text-sm text-slate-600">
          <li>
            Baseline:
            部署ごとに候補者を見て、定員を順に埋めるシンプルな割り当て。
          </li>
          <li>
            DA: 候補者が希望順に応募し、部署は定員内でより優先度が高い人を残す。
          </li>
